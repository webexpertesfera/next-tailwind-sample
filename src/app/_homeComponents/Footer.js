        ...
        <div className="container mx-auto">
          <div className="grid gap-5 grid-cols-1 lg:grid-cols-10">
            <div className="lg:col-span-2">
              ...
              <ul className="font-medium flex flex-row items-start gap-5  mt-8 bg-main-color md:p-0 md:bg-transparent">
                <li>
              ...
              <p className="text-sm mt-8">© 2023 Flight Deck <Link className="ms-5" href="/">Privacy Policy</Link></p>
            </div>
