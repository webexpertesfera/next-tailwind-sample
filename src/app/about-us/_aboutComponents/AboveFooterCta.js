...
export const AboveFooterCta = () => {
  return (
    <section className="relative mt-20 lg:mt-0 z-20 mb-20">
        ...
        <div className="text-center  mx-10 lg:mx-0 bg-second-color bg-cover bg-left-top text-white rounded-3xl relative">
          <div className="grid relative grid-cols-1 lg:grid-cols-4 gap-5 overflow-hidden">
            ...
            <div className="lg:col-span-2 py-10 md:py-16 xl:py-20">
              <h2 className="text-2xl md:text-4xl px-4 lg:px-0 xl:text-5xl  md:m-auto font-semibold">
              Contact
              </h2>
              <p className="text-white text-center my-5 px-4">If your organization works with or near private aviation consumers, we would love to hear from you.</p>
