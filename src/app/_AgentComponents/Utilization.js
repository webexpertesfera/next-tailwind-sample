...
import flight from "../../../public/assets/agents1.json";
import hq from "../../../public/assets/agents.json";
    ...
    <section className="py-12 relative px-4 md:px-8 lg:py-24">
      <div className="container mx-auto">
        ...
        <h2 className="text-3xl text-title-color lg:text-center xl:text-5xl my-5 lg:mb-16 font-semibold">
          Give your clients more than just a recommendation
        </h2>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 items-center">
          <div className="lg:pe-24">
            ...
            <p className="text-base font-medium text-para-color leading-normal mb-5">
              ...
              capture flight requests. Regardless of the implementation, our API
              services will up your offering to clients and put you in direct
              contact with the experts at evoJets for fulfillment.
            </p>
        ...
        <div className="lg:grid lg:grid-cols-2 gap-5  grid-cols-1 flex flex-col-reverse  items-center pt-8 lg:pt-12">
          <div className="text-center">
            <div className="lottie-chart">
              <Lottie
                animationData={hq}
